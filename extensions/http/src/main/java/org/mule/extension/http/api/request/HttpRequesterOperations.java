...
public class HttpRequesterOperations
{
                                                          ...
                                                          MuleEvent muleEvent) throws MuleException
    {
        ...
        //TODO: modify to create a MuleMessage
        HttpResponseToMuleMessage httpResponseToMuleMessage = new HttpResponseToMuleMessage(config, parseResponse);
        MuleMessage<Object, HttpResponseAttributes> muleMessage = httpResponseToMuleMessage.convert(muleEvent, response, httpRequest.getUri());
        ...
        //TODO: Define way to perform the auth resend
