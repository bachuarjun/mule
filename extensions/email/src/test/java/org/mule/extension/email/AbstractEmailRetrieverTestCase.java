...
public abstract class AbstractEmailRetrieverTestCase extends EmailConnectorFunctionalTestCase
{
    ...
    public static final String RETRIEVE_AND_THEN_DELETE = "retrieveAndThenDelete";
    public static final String RETRIEVE_AND_THEN_READ = "retrieveAndThenRead";
    ...
    @Test
    public void checkAndExpungeDelete() throws Exception
    {
