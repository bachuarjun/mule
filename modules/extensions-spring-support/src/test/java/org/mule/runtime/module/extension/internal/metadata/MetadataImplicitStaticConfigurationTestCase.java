...
public class MetadataImplicitStaticConfigurationTestCase extends MetadataExtensionFunctionalTestCase
{
    @Override
    protected String getConfigFile()
    {
        return METADATA_TEST_STATIC_IMPLICIT_CONFIGURATION;
    }

    @Test
    public void resolveMetadataWithImplicitStaticConfig() throws Exception
    {
